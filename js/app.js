// function for loading all the products
const loadProducts = () => {
  // product data
  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `
      <div class="single-product">
        ...
        <h4 class="rating">
          Rating: ${product.rating.rate} <i class="fas fa-star"></i>
          <br>
...
const addToCart = (id, price) => {
  // counting number of total added products
  count = count + 1;
  // updating price
  updatePrice("price", price);
  // updating total tax
  updateTaxAndCharge();
  // updating total added products
...
const updatePrice = (id, value) => {
  ...
  // adding new product's price with old products' price
  const total = convertedOldPrice + convertPrice;
  // setting total upto 2 decimal places in innertext
...
const setInnerText = (id, value) => {
  // setting value upto 2 decimal places in innertext
...
const updateTotal = () => {
  const grandTotal =
    ...
    // setting grandtotal upto 2 decimal places in total's innertext
